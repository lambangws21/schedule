    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {dataList.map((item, index) => (
          <motion.div
            key={index}
            className="bg-gray-900 p-4 rounded-xl shadow-lg border border-gray-700 flex items-center space-x-4"
          ...
          >
            {item.photoUrl ? (
              ...
              <div className="w-24 h-24 flex items-center justify-center bg-gray-800 text-white rounded-full">
                No Image
              </div>
            )}
            <div>
